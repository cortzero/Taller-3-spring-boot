...
public class Institution implements Serializable {
	...
	@NotBlank(message = "Academic Institution password must not be empty", groups = SecondGroup.class)
	@Size(min = 4, max = 20)
	...
	@NotBlank(message = "Academic Login username must not be empty", groups = SecondGroup.class)
	...
	@NotBlank(message = "Institution name must not be empty.", groups = FirstGroup.class)
