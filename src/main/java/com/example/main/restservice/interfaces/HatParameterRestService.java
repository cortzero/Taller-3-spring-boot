...
public ResponseEntity<String> createHatParameter(HatParameter hatParameter);
	
	public ResponseEntity<String> updateHatParameter(long id, HatParameter hatParameter);
